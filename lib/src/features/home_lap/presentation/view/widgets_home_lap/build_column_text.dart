...
class BuildColumnTextWidgetHomeLap extends StatelessWidget {
  const BuildColumnTextWidgetHomeLap({super.key, required this.lapHomeModel});
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          ...
          style: const TextStyle(fontSize: SizeApp.size14),
        ),
        SizeApp.sizeB8,
        Text(' ${StringApp.price}: \$${lapHomeModel.price.toString()}',
        ...
        Text(
          ...
          style: StyleApp.style16we600White.copyWith(color: ColorApp.red),
        ),
        SizeApp.sizeB8,
        Text("${StringApp.company} : ${lapHomeModel.company}",
            style: StyleApp.style18we600black
                .copyWith(color: ColorApp.indigo, fontSize: SizeApp.size14)),
      ],
    );
  }
}
